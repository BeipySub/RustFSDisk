...
fn export_manifest_golden_json_has_prefixed_object_status() {
    let manifest = ExportManifest {
        ...
        objects: vec![ManifestObject {
            ...
            relative_data_path: "data/source-bucket/dir/file.txt.enc".to_owned(),
            encrypted: true,
            encryption_alg: ENCRYPTION_ALG_AES_256_GCM.to_owned(),
            data_key_id: "data-key-001".to_owned(),
            nonce: "nonce-001".to_owned(),
            tag: "tag-001".to_owned(),
            aad: "disk_id=disk-001;seal_id=seal-001;export_job_id=export-job-001;bucket=source-bucket;key=dir/file.txt;chunk_group_id=;chunk_index=0;chunk_total=1;chunk_offset_bytes=0".to_owned(),
    ...
    let expected = json!({
        ...
        "objects": [{
            ...
            "key": "dir/file.txt",
            "relative_data_path": "data/source-bucket/dir/file.txt.enc",
            "encrypted": true,
            "encryption_alg": "AES-256-GCM",
            "data_key_id": "data-key-001",
            "nonce": "nonce-001",
            "tag": "tag-001",
            "aad": "disk_id=disk-001;seal_id=seal-001;export_job_id=export-job-001;bucket=source-bucket;key=dir/file.txt;chunk_group_id=;chunk_index=0;chunk_total=1;chunk_offset_bytes=0",
            "ciphertext_size_bytes": 42,
